...
--	13)	How can you produce a list of the start times for bookings for tennis courts, for the date '2012-09-21'? Return a list of start time and facility 
...
SELECT * FROM cd.bookings AS bookings
INNER JOIN cd.facilities AS facilities
ON bookings.facid = facilities.facid
WHERE facilities.facid IN(0, 1)
AND bookings.starttime >= '2012-09-21' ANd bookings.starttime < '2012-09-22';
...
SELECT starttime FROM cd.members AS members
